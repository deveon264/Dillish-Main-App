...
const styles = StyleSheet.create({
  ...
  cardCat: { fontFamily: fonts.sansSemibold, fontSize: 11, color: colors.accentSoft, letterSpacing: 0.6, textTransform: "uppercase", textShadowColor: "rgba(0,0,0,0.5)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3 },
  cardTagDot: { width: 3, height: 3, borderRadius: 1.5, backgroundColor: "rgba(255,255,255,0.6)" },
  cardLevel: { fontFamily: fonts.sansSemibold, fontSize: 11, color: "#FFFFFF", letterSpacing: 0.6, textTransform: "uppercase", textShadowColor: "rgba(0,0,0,0.5)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3 },
