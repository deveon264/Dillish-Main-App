// AUTO-GENERATED by scripts/import-exercise-db.mts. Do not edit by hand;
// re-run `npm run exercise-db:import` instead.
//
// Source: https://github.com/yuhonas/free-exercise-db
// License: The Unlicense (public domain). See docs/exercise-db-source.md.
// Curated to home-friendly equipment (359 exercises: 353 from
// the dataset plus 6 first-party entries tagged "first-party").
